...
function UpdatePassword({setSettingView}){
    ...
    return<><div className=" pt-6 pb-4 flex items-center gap-1">
  <button
    type="button"
    className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-on-surface-variant 
    hover:bg-surface-container-highest hover:text-on-surface transition-colors">
    <span className="material-symbols-outlined text-[20px]">chevron_left</span>
  </button>

  <h2 className="ml-4 text-[17px] font-semibold text-on-surface">Change Password</h2>
</div>
<form className="flex-1 overflow-y-auto no-scrollbar pb-6 px-3" onSubmit={handleSubmit}>
