...
function ChatHeader({ activeChat , user , otherUserActivity }){
    ...
    return <>
    <div className="absolute top-0 w-full z-10 flex items-center justify-between px-6 h-16 bg-surface/70 backdrop-blur-xl border-b border-outline-variant/30 shrink-0">
        ...
        <div className="flex items-center gap-1">
            <button aria-label="video_call" className="p-2.5 text-on-surface-variant hover:text-on-surface hover:bg-surface-variant/50 rounded-2xl cursor-pointer transition-all duration-300 ease-out active:scale-90">
                <span className="material-symbols-outlined text-[22px]">video_call</span>
            </button>
            <button aria-label="call" className="p-2.5 text-on-surface-variant hover:text-on-surface hover:bg-surface-variant/50 rounded-2xl cursor-pointer transition-all duration-300 ease-out active:scale-90">
                <span className="material-symbols-outlined text-[22px]">call</span>
            </button>
            <button aria-label="more_vert" className="p-2.5 text-on-surface-variant hover:text-on-surface hover:bg-surface-variant/50 rounded-2xl cursor-pointer transition-all duration-300 ease-out active:scale-90">
